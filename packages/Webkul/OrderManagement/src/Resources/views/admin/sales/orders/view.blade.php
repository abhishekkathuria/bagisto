<x-admin::layouts>
    ...
    <div class="mt-5 flex-wrap items-center justify-between gap-x-1 gap-y-2">
        <div class="flex gap-1.5">
            ...
            @if ($order->canEdit())
                <a href="{{ route('order_management.admin.sales.orders.edit', $order->id) }}">
                    <div class="transparent-button px-1 py-1.5 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800">
                        ...
                        @lang('order_management::app.admin.sales.orders.edit.edit')
                    </div>
                </a>
            @endif
                            ...
                            <div class="grid gap-y-2.5">
                                ...
                                <div class="flex gap-2.5">
                                    ...
                                    @if ($invoice->canCancel())
                                        <form
                                            method="POST"
                                            action="{{ route('order_management.admin.sales.invoices.cancel', $invoice->id) }}"
                                            onsubmit="return confirm('@lang('order_management::app.admin.sales.orders.view.confirm-cancel-invoice')');"
                                        ...
                                        >
                                            ...
                                            >
                                                @lang('order_management::app.admin.sales.orders.view.cancel-invoice')
                                            </button>
                                        </form>
                                    @endif
                                </div>
